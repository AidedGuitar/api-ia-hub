...
function LoginMain() {
	return (
		<section className="flex bg-edtech-blue-100 rounded-md md:h-full w-full p-5 md:p-10 gap-5 lg:gap-10 max-w-[1440px] h-[100hv]">
			<div className="bg-white overflow-y-auto flex flex-col h-full gap-2.5 md:gap-3  w-full lg:w-1/2 rounded-md px-5 py-3 md:p-5 shadow-2xl items-center md:pb-10">
				<Image
					src="/logo.webp"
				...
				<div className="flex flex-col gap-3 w-full">
					...
					<p className="text-base">
						...
						<Link
							href="/registro"
							className="text-bismark-600 font-bold underline hover:text-edtech-blue-900">
							reg&iacute;strese
						</Link>
					</p>
				</div>
